    ...
    <div ref={ref} className={`relative ${className} `}>
      ...
      {open && isMobile && (
        <div className=" fixed inset-0 z-50 bg-(--bg-overlay-soft) flex justify-center items-center">
          <div className="relative bg-(--bg-surface-soft) w-full rounded-t-xl p-4 pt-0 max-h-[80vh] overflow-y-auto ">
            <div className="sticky top-0 w-full h-10 text-center font-semibold bg-(--bg-surface-soft) z-2 flex items-center justify-center border-b">
              {titulo}
            </div>
