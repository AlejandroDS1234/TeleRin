  ...
  const getBorderColor = () => {
    switch (tipo) {
      ...
      case "warning":
        return "var(--warning)";
      default:
        return "var(--color_bordes)";
    }
  };

  return (
    //hello
    <div className="flex w-max items-stretch justify-center border-2">
      <div className="w-10 border-r-2 " style={{ backgroundColor: getBorderColor() }}></div>
      <div className="flex flex-col items-center p-4">
        <div className="w-[95%] h-0.75 bg-(--color_bordes) "></div>
...
export function MensajePlano({
  ...
  return (
    <p className={`font-thin`} style={{ color: getBorderColor() }}>
      {mensaje}
    </p>
  );
}
