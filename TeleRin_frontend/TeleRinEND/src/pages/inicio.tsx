...
function ModalSagas({ sagas, cerrar }: { sagas: Saga[]; cerrar: () => void }) {
  return (
    <div className="fixed inset-0 bg-(--fondo_modal) z-50">
      {/* Mobile */}
      <div className="block lg:hidden p-3">
        <div
          className="grid grid-cols-2 gap-8 h-[calc(100vh-80px)] w-full pt-24 overflow-y-auto p-3 z-70"
          onClick={cerrar}
        >
      ...
      {/* Desktop */}
      <div className="hidden lg:block">{/* Próximamente showcase */}</div>
    </div>
  );
}
