        ...
        <button
          ...
          onClick={() => {
            ...
            if (nombreTrim.length === 0) {
              setRes({ mensaje: "El nombre no puede estar vacío", tipo: "danger" });
              return;
            }
            if (nombreTrim.length > 30) {
              setRes({ mensaje: "El nombre no puede tener más de 30 caracteres", tipo: "danger" });
              return;
            }
            cambiarDato(
              { nombre_usuario: nombreTrim, mensaje: "Nombre actualizado" },
              setCambioNombre,
              setCargandoNombre,
              setRes,
              setUsuario
        ...
        <button
          ...
          onClick={() => {
            ...
            if (descripcionTrim.length === 0) {
              setRes({ mensaje: "La descripción no puede estar vacía", tipo: "danger" });
              return;
            }
            ...
            cambiarDato(
              { descripcion_personal: descripcionTrim, mensaje: "Descripción actualizada" },
              setCambioDescripcion,
              setCargandoDescripcion,
              setRes,
              setUsuario
            );
          }}
            ...
            <ThumbsUp
              ...
              onClick={async () => {
                ...
                if (res.tipo === "success" && res.foto_perfil_usuario) {
                  setUsuario((prev) =>
                    prev ? { ...prev, foto_perfil_usuario: res.foto_perfil_usuario! } : prev
                  );
                  setTimeout(() => {
                    limpiarSeleccionFoto();
                    setRes(null);
    ...
    <div className="flex flex-col w-full">
      <select
        ...
        onChange={(e: ChangeEvent<HTMLSelectElement>) => {
          ...
          cambiarDato(
            { id_pais: e.target.value, mensaje: "PaÃ­s actualizado" },
            null,
            setCargando,
            setRes,
            setUsuario
    ...
    <div className="flex flex-col w-full">
      <select
        ...
        onChange={(e: ChangeEvent<HTMLSelectElement>) => {
          ...
          cambiarDato(
            { id_genero: e.target.value, mensaje: "GÃ©nero actualizado" },
            null,
            setCargando,
            setRes,
            setUsuario
